...
class MindBugsParser(BaseParser):
    ...
    def parse_dataset(self):
        ...
        self.set_subject(self.parse_subjects(self.target_df["subject"]))
        self.set_verdict_column(self.target_df["verdict"].str.lower())
        self.set_speaker(self.target_df["speaker"])

        self.set_summary(self.target_df["summary_explanation"])
        self.set_explanation(self.target_df["full_explanation"])
